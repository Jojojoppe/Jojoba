...
ImGui_vermilion::ImGui_vermilion(std::shared_ptr<VmInstance> instance, int width, int height){
...
ImGui_vermilion::~ImGui_vermilion(){
    ImGui::DestroyContext();
}

void ImGui_vermilion::render(){
    ImGui::Render();
...
void ImGui_vermilion::resize(int width, int height){
    ImGuiIO& io = ImGui::GetIO();
    io.DisplaySize = ImVec2((float)width, (float)height);
...
void ImGui_vermilion::mouseButton(Vermilion::Core::WindowMouseButton btn, Vermilion::Core::WindowMouseAction act){
    ImGuiIO& io = ImGui::GetIO();
...
void ImGui_vermilion::mousePos(double x, double y){
    ImGuiIO& io = ImGui::GetIO();
    io.MousePos = ImVec2((float)x, (float)y);
}

void ImGui_vermilion::scroll(double x, double y){
    ImGuiIO& io = ImGui::GetIO();
    io.MouseWheel = y;
}
